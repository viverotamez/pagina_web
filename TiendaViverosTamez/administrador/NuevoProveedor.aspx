<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="NuevoProveedor.aspx.cs" Inherits="TiendaViverosTamez.administrador.NuevoProveedor" %>
            ...
            <div class="col-12">
                <div class="card">
				    <div class="card-header" style="background-color:#28a745;">
				        <h3 style="color:#ffff;">Agregar nuevo proveedor</h3>
				    </div>
				    <div class="card-body">
