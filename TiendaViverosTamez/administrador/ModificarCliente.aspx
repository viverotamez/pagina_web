<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ModificarCliente.aspx.cs" Inherits="TiendaViverosTamez.administrador.ModificarCliente" %>
            ...
            <div class="col-12">
                <div class="card">
				    <div class="card-header" style="background-color:#28a745;">
				        <h3 style="color:#ffff;">Modificar cliente</h3>
				    </div>
				    <div class="card-body">
