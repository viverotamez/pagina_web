<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ModificarUsuario.aspx.cs" Inherits="TiendaViverosTamez.administrador.ModificarUsuario" %>
            ...
            <div class="col-12">
                <div class="card">
				    <div class="card-header" style="background-color:#28a745;">
				        <h3 style="color:#ffff;">Modificar datos del usuario</h3>
				    </div>
				    <div class="card-body">
