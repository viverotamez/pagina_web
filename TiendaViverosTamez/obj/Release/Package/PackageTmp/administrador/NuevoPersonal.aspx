<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="NuevoPersonal.aspx.cs" Inherits="TiendaViverosTamez.administrador.NuevoPersonal" %>
            ...
            <div class="col-12">
                <div class="card">
				    <div class="card-header" style="background-color:#28a745;">
				        <h3 style="color:#ffff;">Agregar nuevo empleado</h3>
				    </div>
				    <div class="card-body">
